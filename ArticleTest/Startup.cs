using ArticleTest.Common;
using ArticleTest.Common.HttpClient;
using ArticleTest.Common.Interface;
using ArticleTest.Common.Settings;
using ArticleTest.Security;
...
namespace ArticleTest
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient<IArticleHttpClient, ArticleHttpClient>(client => client.BaseAddress = new Uri(appSettings.aritcleApiURL));
